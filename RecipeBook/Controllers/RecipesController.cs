...
namespace RecipeBook.Controllers
{
  public class RecipesController : Controller
  {
    ...
    public ActionResult Edit(int id)
    {
      ...
      ViewBag.CategoryId = new SelectList(_db.Categoris, "CategoryId", "CategoryName");
      return View(thisRecipe);
    }
    ...
    public ActionResult AddCategory(Recipe recipe, int CategoryId)
    {
      if (CategoryId != 0)
      {
        __db.CategoryRecipe.Add(new CategoryRecipe() { CategoryId = CategoryId, RecipeId = recipe.RecipeId });
      }
      _db.SaveChanges();
      return RedirectToAction("Index");
    }
